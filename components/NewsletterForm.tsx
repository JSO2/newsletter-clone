  ...
  return (
    <div className='flex flex-col space-y-8 md:w-[400px]'>
        <form className='newsletter-form mt-10 animate-fade-in-3' onSubmit= {handleSubmit}>
            <div className='group flex items-center gap-x-4 py-1 pl-4 pr-1 rounded-[9px] bg-[#090D11] hover:bg-[#15141B] shadow-outline-gray
            hover:shadow-transparent focus-within:bg-[#15141B]
            focus-within:!shadow-outline-gray-focus transition-all duration-300'>
                ...
                group-focus-within:placeholder-white  group-focus-within:placeholder:italic bg-transparent placeholder:transition-colors placeholder:duration-300 hover:placeholder:italic '  />
          ...
          py-4 px-6 animate-fade-bottom absolute">
            ...
            {successMessage ? (
                <p>
                  ...
                  to our waitlist. We&apos;ll keep you posted on our latest news!
                </p>
              ) : (
                <p>
                  You are already added to our waitlist. We&apos;ll keep you posted on our latest news!
                </p>
              )}
            </div>
            <XMarkIcon
